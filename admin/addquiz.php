        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- Subject Modal form  -->
                    <form action="./select_questions.php" method="post" class="row g-3 needs-validation"
                        novalidate>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!-- Subject Modal form  -->
                    <form action="./addquiz.php" method="post" class="row g-3 needs-validation" novalidate>
            ...
            Array.from(qdeletes).forEach((element) => {
                element.addEventListener("click", (e) => {
                    ...
                    if (confirm("Are you sure you want to delete this user?")) {
                        console.log("yess");
                        window.location = `./addquiz.php?qdelete=${sno}`;
                    } else {
                        console.log("no");
                    }
