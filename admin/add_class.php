...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <!-- <a class="navbar-brand" href="./addstudent.php"><b>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="./add_class.php" method="post" class="row g-3 needs-validation" novalidate>
                        <div class="mb-3">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!-- Subject Modal form  -->
                    <form action="/admin/add_class.php" method="post" class="row g-3 needs-validation" novalidate>
                        <div class="mb-3">
    ...
    -->
                ...
                element.addEventListener("click", (e) => {
                    ...
                    if (confirm("Are you sure you want to delete this class?")) {
                        if (confirm("!!!Alert!!! \n \n You will loose all the students. Are you sure you want to delete this class?")) {
                            console.log("yess");
                            window.location = `./add_class.php?udelete=${sno}`;
                        } else {
                            console.log("no");
                        }
                    } else {
            ...
            Array.from(dviews).forEach((element) => {
                element.addEventListener("click", (e) => {
                    sno = e.target.id.substr(1, );
                    console.log(sno);
                    window.location = `./class.php?view=${sno}`;
                })
            })
