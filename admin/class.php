...
?>
   ...
   <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <!-- <a class="navbar-brand" href="./add_class.php"><b>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="./class.php" method="post" class="row g-3 needs-validation" novalidate>
                        <div class="mb-3">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!-- Subject Modal form  -->
                    <form action="./class.php" method="post" class="row g-3">
                        <div class="mb-3">
        ...
        Array.from(udeletes).forEach((element) => {
            element.addEventListener("click", (e) => {
                ...
                if (confirm("Are you sure you want to delete this user?")) {
                    console.log("yess");
                    window.location = `./class.php?udelete=${sno}`;
                } else {
                    console.log("no");
                }
