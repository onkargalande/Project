        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!-- Modal form  -->
                    <form action="./addquestions.php" method="post" class="row g-3 needs-validation"
                        novalidate>
                        <div class="mb-3">
        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!-- Modal form  -->
                    <form action="./addquestions.php" method="post" class="row g-3 needs-validation" enctype="multipart/form-data"
                        novalidate>
                        <div class="mb-3">
                            <label for="subjectid" class="form-label">Subject</label>
        ...
        Array.from(qdeletes).forEach((element) => {
            element.addEventListener("click", (e) => {
                ...
                if (confirm("Are you sure you want to delete this question?")) {
                    console.log("yess");
                    window.location = `./addquestions.php?qdelete=${qid}`;
                } else {
                    console.log("no");
                }
